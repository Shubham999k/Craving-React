        ...
        const messageHTML = `
            <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #e2e8f0;">
                ...
                <div style="background: linear-gradient(135deg, #ea580c 0%, #f97316 100%); padding: 40px 20px; text-align: center;">
                    ...
                    <p style="color: #ffedd5; font-style: italic; font-size: 16px; margin-top: 10px; font-weight: 500;">"Where every bite is a celebration of taste."</p>
                </div>
                ...
                <div style="padding: 40px 30px;">
                    ...
                    <!-- Cool Gradient OTP Box -->
                    <div style="text-align: center; margin: 40px 0;">
                        <span style="background: linear-gradient(135deg, #ea580c 0%, #c2410c 100%); color: #ffffff; padding: 18px 40px; font-size: 32px; font-weight: 900; letter-spacing: 10px; border-radius: 12px; display: inline-block;">
                            ${otpCode}
                        </span>
                    </div>
