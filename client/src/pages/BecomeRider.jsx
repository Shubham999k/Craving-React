      ...
      <div className="mx-auto w-full max-w-xl relative z-10 opacity-0 animate-fade-in-up">
        <div className="text-center mb-12 relative">
          ...
          <div className="w-20 h-20 bg-white/80 dark:bg-slate-800/80 backdrop-blur-md rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-orange-500/20 border border-slate-100/50 dark:border-slate-700/50 animate-float">
            <i className="bi bi-bicycle text-4xl text-transparent bg-clip-text bg-gradient-to-br from-[#c74a09] to-orange-400"></i>
          </div>
          
          <h1 className="text-5xl lg:text-6xl font-black text-slate-900 dark:text-white mb-4 tracking-tight drop-shadow-sm">
            Become a <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-600 to-amber-500 animate-gradient-x">Rider</span>
          </h1>
        ...
        <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-2xl p-8 md:p-12 rounded-[2.5rem] border border-white/50 dark:border-slate-700/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] hover:shadow-2xl hover:shadow-orange-500/20 dark:hover:shadow-orange-500/10 hover:-translate-y-2 transition-all duration-500 relative overflow-hidden group">
          ...
          {submitted ? (
            <div className="text-center space-y-6 py-8 animate-fade-in-up">
              ...
              <div>
                <h3 className="text-3xl font-black text-slate-900 dark:text-white mb-3">Rider Profile Submitted!</h3>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              <div>
                <label className="block text-xs font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-2 ml-1">Full Name</label>
                <input
                  type="text"
                  required
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-2 ml-1">Email</label>
                  <input
                    type="email"
                    required
                    className="w-full rounded-2xl border border-white/40 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 backdrop-blur-sm text-slate-800 dark:text-slate-100 px-5 py-4 outline-none transition-all focus:border-orange-500 focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-orange-500/20 placeholder-slate-400 font-semibold shadow-inner"
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-xs font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-2 ml-1">Vehicle Type</label>
                  <select
                    className="w-full rounded-2xl border border-white/40 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 backdrop-blur-sm text-slate-800 dark:text-slate-100 px-5 py-4 outline-none transition-all focus:border-orange-500 focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-orange-500/20 font-semibold shadow-inner appearance-none cursor-pointer"
                ...
                <div>
                  <label className="block text-xs font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-2 ml-1">Operating City</label>
                  <input
                    type="text"
                    required
                    className="w-full rounded-2xl border border-white/40 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 backdrop-blur-sm text-slate-800 dark:text-slate-100 px-5 py-4 outline-none transition-all focus:border-orange-500 focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-orange-500/20 placeholder-slate-400 font-semibold shadow-inner"
              ...
              <div>
                <label className="block text-xs font-black uppercase tracking-widest text-slate-500 dark:text-slate-400 mb-2 ml-1">Driving License Number</label>
                <input
                  type="text"
                  required
                  className="w-full rounded-2xl border border-white/40 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 backdrop-blur-sm text-slate-800 dark:text-slate-100 px-5 py-4 outline-none transition-all focus:border-orange-500 focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-orange-500/20 placeholder-slate-400 font-semibold shadow-inner"
