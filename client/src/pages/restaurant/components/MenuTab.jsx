              ...
              <form id="add-item-form" onSubmit={handleSaveItem} className="flex-1 overflow-y-auto px-8 py-2 space-y-6 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700 pb-8">
                ...
                {!newItem.image && (
                  <div className="relative group">
                    ...
                    <input type="url" value={newItem.image} onChange={e => setNewItem({ ...newItem, image: e.target.value })} className={`${styles.form.input} pl-11 pr-4 font-semibold`} placeholder="https://example.com/image.jpg" />
                  </div>
                )}
                ...
                <div className="space-y-5">
                  <div className="space-y-1.5">
                    ...
                    <input required type="text" value={newItem.name} onChange={e => setNewItem({ ...newItem, name: e.target.value })} className={`${styles.form.input} px-4 font-bold`} placeholder="e.g. Signature Truffle Burger" />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div className="space-y-1.5">
                      ...
                      <div className="relative group">
                        ...
                        <input required type="number" step="0.01" value={newItem.price} onChange={e => setNewItem({ ...newItem, price: e.target.value })} className={`${styles.form.input} pl-8 pr-4 font-bold`} placeholder="0.00" />
                      </div>
                    </div>
                  ...
                  <div className="space-y-1.5 pb-2">
                    ...
                    <textarea required rows="3" value={newItem.description} onChange={e => setNewItem({ ...newItem, description: e.target.value })} className={`${styles.form.input} px-4 font-semibold resize-none`} placeholder="What makes this dish special?..."></textarea>
                  </div>
                </div>
              </form>
            )}
